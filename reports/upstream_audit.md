...
| Direct | ChinaMaxNoIP | included | 111837 | 111837 | 0 | 已合入配置 |
| Direct | ChinaIPs | intentional | 22835 | 1 | 22834 | 未合入完整 ChinaIPs。建议在 Clash/Mihomo 配置末尾使用 `GEOIP,CN,DIRECT` 覆盖中国大陆 IP，避免 rule-provider 过大。 |
